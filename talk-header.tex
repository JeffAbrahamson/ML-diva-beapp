...
\newcommand\talksectionT[2]{\section{#1}
\begin{frame}
  \vfill
  \Huge\bf\blue{\centerline{#1}}
  \vfill
...
\setbeamertemplate{footline}[text line]{%
  \parbox{0.8\linewidth}{
    ...
    \vspace*{-8pt}Copyright 2024 Jeff Abrahamson,
    \faCreativeCommons\hspace{-.2mm}
    \faCreativeCommonsBy\hspace{-.2mm}
    \faCreativeCommonsSa\hspace{.3mm}
    CC BY-SA 4.0
  }
  \hfill%
  \parbox{.2\linewidth}{\vspace*{-8pt}{Diva / Beapp}}
  \hfill%
