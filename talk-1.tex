...
\begin{frame}
  ...
  \only<1>{\purple{Draw a line}
    ...
    \vspace{-19mm}
    \flushright{\includegraphics[width=.5\textwidth]{images/pyplot_1.png}}
  }
  \only<2>{\purple{Draw a line}
    \lstinputlisting{code/pyplot_2.py}
    \vspace{-19mm}
    \flushright{\includegraphics[width=.5\textwidth]{images/pyplot_2.png}}
  }
  \only<3>{\purple{Draw a line}
    \lstinputlisting{code/pyplot_3.py}
    \vspace{-55mm}
    \flushright{\includegraphics[width=.5\textwidth]{images/pyplot_3.png}}
  }
  \only<4>{\purple{Draw two curves}
    \lstinputlisting{code/pyplot_4.py}
  }
  \only<5>{
    \flushright{\includegraphics[width=.5\textwidth]{images/pyplot_4.png}}
  }
  \only<6>{\purple{Draw two curves}
    \lstinputlisting{code/pyplot_5.py}
  }
  \only<7>{
    \flushright{\includegraphics[width=.5\textwidth]{images/pyplot_5.png}}
  }
  \only<8>{\purple{Scatter plot}
    ...
    \vspace{-60mm}
    \flushright{\includegraphics[width=.5\textwidth]{images/pyplot_6.png}}
...
\begin{frame}
  ...
  \vspace{1cm}
  \centerline{\includegraphics[height=.4\textheight]{images/regression.png}}
...
\begin{frame}
  ...
  \vspace{1cm}
  \centerline{\includegraphics[height=.4\textheight]{images/linear-regression.png}}
...
\begin{frame}
  ...
  \vspace{1cm}
  \centerline{\includegraphics[height=.4\textheight]{images/linear-regression-2.png}}
